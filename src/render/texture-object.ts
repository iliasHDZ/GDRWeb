import { ObjectSprite } from "../object/info/object-info";
...
export class TextureObject {
    ...
    constructor(model: Mat3, color: number, sprite: ObjectSprite, groups: number[], transformId: number, objectPos: Vec2, hsvId: number, black: boolean, trigger: boolean, secondTexture = false) {
        this.model   = model;
        this.color   = color;
        this.sprite  = sprite;
        this.groups  = groups;
